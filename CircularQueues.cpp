 ...
 *
 * @author Profil
 * - nama : Rafi'i Arif Nugroho
 * - nim  : 20240140007
 * - kelas : B
 *
 * @brief CircularQueuesArray
 * @version 1.0
 * @date 2026-06-09
 *
 * @copyright rafii.arif.ft24@mail.umy.ac.id (c) 2026
 */
...
private:
    ...
    int max = 3;        ///< variable private max untuk menyimpan ukuran maximum antrian
    int queue_array[3]; ///< varibale private queue_array untuk menyimpan elemen antrian
